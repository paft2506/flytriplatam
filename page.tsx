...
export default function HomePage() {
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #0f1c2e 0%, #162236 60%, #1a2d4f 100%)', minHeight: '100vh', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
