    ...
    <div className="bg-navy">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-24 pb-16 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold text-white leading-[1.05] mb-6">
              Flota ociosa.<br /><span className="text-crimson">Demanda real.</span>
            </h1>
          ...
          <div className="grid grid-cols-1 gap-4">
            {[
              ...
              <div key={item.title} className="flex gap-4 p-5 bg-navy-light border border-white/5 rounded-sm hover:border-gold/20 transition-colors group">
                <div className="w-9 h-9 bg-crimson/10 rounded-sm flex items-center justify-center flex-shrink-0 group-hover:bg-crimson/20 transition-colors">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 mb-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
          <div className="bg-navy-light border border-white/5 rounded-sm p-8">
            ...
            <ul className="flex flex-col gap-2 mb-8">
              {['Charter corporativo y ejecutivo', 'Grupos y delegaciones', 'Carga urgente y especializada', 'Operaciones médicas o humanitarias'].map(i => (
                <li key={i} className="flex items-center gap-2 text-slate text-sm"><ChevronRight size={12} className="text-crimson" />{i}</li>
              ))}
            </ul>
          ...
          <div className="flex flex-col items-center gap-4 py-8">
            <div className="w-12 h-12 bg-crimson/10 border border-crimson/20 rounded-sm flex items-center justify-center">
              <Zap size={20} className="text-crimson" />
            </div>
          ...
          <div className="bg-navy-light border border-white/5 rounded-sm p-8">
            <p className="font-mono text-xs tracking-widest uppercase text-gold/60 mb-4">Oferta</p>
            <h3 className="text-2xl font-bold text-white mb-4">¿Tienes flota disponible?</h3>
            <p className="text-slate text-sm leading-relaxed mb-6">Para lessors, operadores, charter providers y dueños de flota que buscan exposición a demanda real y capacidad ociosa.</p>
            <ul className="flex flex-col gap-2 mb-8">
              {['ACMI / Wet Lease', 'Full Charter', 'Cargo Charter', 'Capacidad ociosa / disponibilidad'].map(i => (
                <li key={i} className="flex items-center gap-2 text-slate text-sm"><ChevronRight size={12} className="text-gold" />{i}</li>
              ))}
            </ul>
            <Link href="/registrar-flota" className="inline-flex items-center gap-2 px-5 py-2.5 border border-gold/40 text-gold font-semibold text-xs tracking-wide rounded-sm hover:border-gold hover:bg-gold/10 transition-colors">
              Registrar flota
            </Link>
          </div>
        </div>
          ...
          {steps.map((step) => (
            <div key={step.num} className="bg-navy-light border border-white/5 rounded-sm p-6 hover:border-gold/20 transition-colors">
              <div className="flex items-center gap-3 mb-4">
                <span className="font-mono text-xl font-bold text-crimson">{step.num}</span>
